...
public class Cultive {
	...
	public Cultive(int year, Species species, int cultivatedQuantity,
			int harvestedQuantity, double averageWeightByHarvestedAnimalKg) {
		this.id = ++sequential;
		this.year = year;
	...
	public Object[] toObjectVector() {
		return new Object[] { this.id, this.year,
				Util.getConvertedSpeciesName(this.species),
				this.cultivatedQuantity, this.harvestedQuantity,
				this.calculateTotalCultiveWeightKg(),
				this.calculateTotalCultiveCost(),
				this.averageWeightByHarvestedAnimalKg };
	}
}