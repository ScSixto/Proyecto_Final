...
public class Util {
	...
	public static String getConvertedTownAndSpeciesName(String town) {
		return town.substring(0, 1).toUpperCase()
				+ town.substring(1).toLowerCase();
	}
	...
	public static HashMap<String, Object> convertToReportPerYear(
		...
		while (it.hasNext()) {
			...
			reportFormat.put("" + entry.getKey(),
					Double.parseDouble("" + entry.getValue()));
		}
		return reportFormat;
	}

	public static HashMap<String, Object> convertToReportPerTown(
			HashMap<Town, Double> data) {
		HashMap<String, Object> reportFormat = new HashMap<>();
		Iterator<Entry<Town, Double>> it = data.entrySet().iterator();
		while (it.hasNext()) {
			Entry<Town, Double> entry = it.next();
			reportFormat.put(getConvertedTownName(entry.getKey()),
					entry.getValue());
		}
		return reportFormat;
	}
	...
	public static String getConvertedTownName(Town town) {
		return town.getName().substring(0, 1).toUpperCase()
				+ town.getName().substring(1).toLowerCase();
	}

	public static String getConvertedSpeciesName(Species species) {
		return species.getName().substring(0, 1).toUpperCase()
				+ species.getName().substring(1).toLowerCase();
	}

	public static HashMap<String, Object> convertToReportPerSpecies(
			HashMap<Species, Double> data) {
		HashMap<String, Object> reportFormat = new HashMap<>();
		Iterator<Entry<Species, Double>> it = data.entrySet().iterator();
		while (it.hasNext()) {
			Entry<Species, Double> entry = it.next();
			reportFormat.put(getConvertedSpeciesName(entry.getKey()),
					entry.getValue());
		}
		return reportFormat;
	}

	public static HashMap<String, Object> convertToReportPerSpeciesPerYear(
			HashMap<Integer, HashMap<Species, Double>> data) {
		HashMap<String, Object> reportFormat = new HashMap<>();
		HashMap<String, Object> hashTemp;
		Iterator<Entry<Integer, HashMap<Species, Double>>> it1 = data
				.entrySet().iterator();
		while (it1.hasNext()) {
			Entry<Integer, HashMap<Species, Double>> entry1 = it1.next();
			Iterator<Entry<Species, Double>> it2 = entry1.getValue().entrySet()
					.iterator();
	...
	public static HashMap<String, Object> convertToReportFood(
			HashMap<Food, Integer> data) {
		HashMap<String, Object> reportFormat = new HashMap<>();
		Iterator<Entry<Food, Integer>> it = data.entrySet().iterator();
		while (it.hasNext()) {
			Entry<Food, Integer> entry = it.next();
			reportFormat.put(entry.getKey().getName(),
					Double.parseDouble("" + entry.getValue()));
		}
		return reportFormat;
	}

	public static HashMap<String, Object> convertToReportWaterType(
			HashMap<WaterType, Integer> data) {
		HashMap<String, Object> reportFormat = new HashMap<>();
	...
	public static HashMap<String, Object> convertToReportPerTownPerYear(
			HashMap<Integer, HashMap<Town, Double>> data) {
		HashMap<String, Object> reportFormat = new HashMap<>();
		HashMap<String, Object> hashTemp;
		Iterator<Entry<Integer, HashMap<Town, Double>>> it1 = data.entrySet()
				.iterator();
		while (it1.hasNext()) {
			Entry<Integer, HashMap<Town, Double>> entry1 = it1.next();
			Iterator<Entry<Town, Double>> it2 = entry1.getValue().entrySet()
					.iterator();
			hashTemp = new HashMap<>();
			while (it2.hasNext()) {
				Entry<Town, Double> entry2 = it2.next();
				hashTemp.put(getConvertedTownName(entry2.getKey()),
						entry2.getValue());
			}
			reportFormat.put("" + entry1.getKey(), hashTemp);
		}
	...
	public static HashMap<String, Object> convertToReportPerYearPerCultiveState(
			HashMap<Character, HashMap<Integer, Long>> data) {
		HashMap<String, Object> report = new HashMap<>();
		HashMap<String, Object> hashTemp;
		Iterator<Entry<Character, HashMap<Integer, Long>>> it1 = data
				.entrySet().iterator();
		while (it1.hasNext()) {
			Entry<Character, HashMap<Integer, Long>> entry1 = it1.next();
			Iterator<Entry<Integer, Long>> it2 = entry1.getValue().entrySet()
					.iterator();
			hashTemp = new HashMap<>();
			while (it2.hasNext()) {
	...
	public static HashMap<String, Object> convertToReportPerTownPerCultiveStatePerYear(
			HashMap<Character, HashMap<Integer, HashMap<Town, Double>>> data) {
		HashMap<String, Object> report = new HashMap<>();
		HashMap<String, Object> hashTemp1;
		HashMap<String, Object> hashTemp2;
		Iterator<Entry<Character, HashMap<Integer, HashMap<Town, Double>>>> it1 = data
				.entrySet().iterator();
		while (it1.hasNext()) {
			Entry<Character, HashMap<Integer, HashMap<Town, Double>>> entry1 = it1
					.next();
			Iterator<Entry<Integer, HashMap<Town, Double>>> it2 = entry1
					.getValue().entrySet().iterator();
			hashTemp2 = new HashMap<>();
			while (it2.hasNext()) {
				Entry<Integer, HashMap<Town, Double>> entry2 = it2.next();
				Iterator<Entry<Town, Double>> it3 = entry2.getValue()
						.entrySet().iterator();
				hashTemp1 = new HashMap<>();
				while (it3.hasNext()) {
					Entry<Town, Double> entry3 = it3.next();
					hashTemp1.put(getConvertedTownName(entry3.getKey()),
							entry3.getValue());
				}
