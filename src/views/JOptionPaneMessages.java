...
public class JOptionPaneMessages {
	...
	public static final Object[] BUTTONS = {
			HandlerLanguage.languageProperties
					.getProperty(ConstantsGUI.BUTTON_YES),
			HandlerLanguage.languageProperties
					.getProperty(ConstantsGUI.BUTTON_NO) };
	...
	public static int showMessage(String message, String title, int icon) {
		Object[] buttons = new Object[] { HandlerLanguage.languageProperties
				.getProperty(ConstantsGUI.BUTTON_ACCEPT) };
		return JOptionPane.showOptionDialog(null, message, title,
				JOptionPane.YES_OPTION, icon, null, buttons, buttons[0]);
	}
	...
	public static int showMessageConfirmation(String message) {
		...
		return JOptionPane.showOptionDialog(null, message,
				HandlerLanguage.languageProperties
						.getProperty(ConstantsGUI.T_CONFIRMATION),
	...
	public static void showMessageEndProgram() {
		showMessage(
				HandlerLanguage.languageProperties
						.getProperty(ConstantsGUI.T_MESSAGE_END_PROGRAM),
				HandlerLanguage.languageProperties
						.getProperty(ConstantsGUI.T_EXIT),
				JOptionPane.INFORMATION_MESSAGE);
	}

	public static int showMessageConfirmationEndProgram() {
		return showMessageConfirmation(HandlerLanguage.languageProperties
				.getProperty(ConstantsGUI.T_MESSAGE_CONFIRMATION_END_PROGRAM));
	}

	// public static int showMessageConfirmationDelete() {
	// return
	// JOptionPane.showConfirmDialog(null,Constants.MESSAGE_CONFIRMATION_DELETE,"Confirmaci�n",JOptionPane.YES_NO_OPTION);
	// }
	//
	// public static int showMessageConfirmationEdit() {
	// return
	// JOptionPane.showConfirmDialog(null,Constants.MESSAGE_CONFIRMATION_EDIT,"Confirmaci�n",JOptionPane.YES_NO_OPTION);
	// }
	...
	public static void showMessageExport() {
		showMessage("Archivo exportado", "Exportar", JOptionPane.PLAIN_MESSAGE,
				UtilView.convertToIcon("resources/img/export.png", 40, 40));
	}
