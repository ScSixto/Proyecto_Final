...
public class JPanelLanguage extends JPanel {
	...
	private void initComponents(ActionListener actionListener) {
		spanishButton = new JButtonsMenuAndDialogs("resources/img/BanderaEspa"
				+ ConstantsGUI.LOWERCASE_ACCENTED_N + "a.png", WHIDTH, HEIGHT);
		spanishButton.setToolTipText(HandlerLanguage.languageProperties
		...
		englishButton = new JButtonsMenuAndDialogs(
				"resources/img/BanderadelReinoUnido.png", WHIDTH, HEIGHT);
		englishButton.setToolTipText(HandlerLanguage.languageProperties
