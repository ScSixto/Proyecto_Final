...
public class JLArcLabel extends JPanel {
	...
	public JLArcLabel(HashMap<String, Double> valueList,
			HashMap<String, Color> informationPanelData) {
		this.setPreferredSize(new Dimension(
				(int) (ConstantsGUI.CIRCLE_GRAPHIC_RADIOUS * 2)
						+ ConstantsGUI.CIRCLE_GRAPHIC_OVAL_SPACE,
				(int) (ConstantsGUI.CIRCLE_GRAPHIC_RADIOUS * 2)
						+ ConstantsGUI.CIRCLE_GRAPHIC_OVAL_SPACE));
	...
	public void paint(Graphics g) {
		...
		g.fillOval(0, 0, (int) (ConstantsGUI.CIRCLE_GRAPHIC_RADIOUS * 2),
				(int) (ConstantsGUI.CIRCLE_GRAPHIC_RADIOUS * 2));
		;
		// g.setColor(new Color(21,19,19,25));
		// g.fillOval(0, ConstantsGUI.CIRCLE_GRAPHIC_OVAL_SPACE/2,
		// (int)(ConstantsGUI.CIRCLE_GRAPHIC_RADIOUS*2),
		// (int)(ConstantsGUI.CIRCLE_GRAPHIC_RADIOUS*2));;
		// g.setColor(new Color(21,19,19,25));
		// g.fillOval(0, ConstantsGUI.CIRCLE_GRAPHIC_OVAL_SPACE/3,
		// (int)(ConstantsGUI.CIRCLE_GRAPHIC_RADIOUS*2),
		// (int)(ConstantsGUI.CIRCLE_GRAPHIC_RADIOUS*2));;
		...
		while (it.hasNext()) {
			...
			int arcAngle = (int) UtilView.getCircleGraphicAngle(
					this.circleMaxValue, column.getValue());
			g.setColor(arcColor);
			g.fillArc(0, 0, (int) (ConstantsGUI.CIRCLE_GRAPHIC_RADIOUS * 2),
					(int) (ConstantsGUI.CIRCLE_GRAPHIC_RADIOUS * 2),
					(int) startAngle, arcAngle + 2);
			startAngle += UtilView.getCircleGraphicAngle(this.circleMaxValue,
					column.getValue());

		}
		// Graphics2D g2 = (Graphics2D) g;
		// g2.setPaint(new Paint(new GradientPaint(0, 0, Color.darkGray, 70, 70,
		// Color.white)));
		// g2.setPaint(new GradientPaint(0, 0, Color.darkGray, 70, 70,
		// Color.white));
		// g.setColor(ConstantsGUI.GRAPHIC_BORDER_COLOR);
		// g.setClip(5, 5, 5, 5);
		// g.drawLine(0, 0, 0, (int)(this.getHeight()*0.99));
		// g.drawLine((int)(this.getWidth()*0.99), 0,
		// (int)(this.getWidth()*0.99), (int)(this.getHeight()*0.99));
		// g.drawLine(0, (int)(this.getHeight()*0.99),
		// (int)(this.getWidth()*0.99), (int)(this.getHeight()*0.99));
