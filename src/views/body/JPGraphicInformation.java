...
public class JPGraphicInformation extends JPanel {
	...
	public JPGraphicInformation(HashMap<String, Color> columnInformation) {
		// this.setMaximumSize(new Dimension(ConstantsGUI.MAXIMUM_SCREEN_WIDTH *
		// 1/5,ConstantsGUI.MAX_PIXEL_COL_HEIGHT_VALUE +
		// ConstantsGUI.AXIS_LINE_WIDTH));
		// this.setMaximumSize(new Dimension(50,
	...
	private void initComponents(HashMap<String, Color> columnInformation) {
		...
		Iterator<Entry<String, Color>> it = columnInformation.entrySet()
				.iterator();
		while (it.hasNext()) {
			Entry<String, Color> entry = it.next();
			this.contentPanel.add(new JLInformationLabel(entry.getKey(), entry
					.getValue()));
		}
	...
	public void setContentPanel() {
		...
		// this.contentPanel.setMaximumSize(new
		// Dimension(300,ConstantsGUI.MAX_PIXEL_COL_HEIGHT_VALUE +
		// ConstantsGUI.AXIS_LINE_WIDTH));
