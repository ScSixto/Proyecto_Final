...
public class JPanelButtonsTablesReport extends JPanel {
	...
	private JButtonOptionsReports cultivesPerTown, cultivesPerYear,
			cultivesPerSpecie;
	...
	public void addButtons(ActionListener actionListener) {
		cultivesPerTown = new JButtonOptionsReports(
				HandlerLanguage.languageProperties
						.getProperty(ConstantsGUI.T_TEXT_REPORT_GRAPHICS_EIGHT),
				ConstantsGUI.TABLE_REPORT);
		...
		cultivesPerYear = new JButtonOptionsReports(
				HandlerLanguage.languageProperties
						.getProperty(ConstantsGUI.T_TEXT_REPORT_GRAPHICS_NINE),
				ConstantsGUI.TABLE_REPORT);
		...
		cultivesPerSpecie = new JButtonOptionsReports(
				HandlerLanguage.languageProperties
						.getProperty(ConstantsGUI.T_TEXT_REPORT_GRAPHICS_TEN),
				ConstantsGUI.TABLE_REPORT);
	...
	public void changeLanguage() {
		cultivesPerTown.setNewText(HandlerLanguage.languageProperties
				.getProperty(ConstantsGUI.T_TEXT_REPORT_GRAPHICS_EIGHT));
		cultivesPerYear.setNewText(HandlerLanguage.languageProperties
				.getProperty(ConstantsGUI.T_TEXT_REPORT_GRAPHICS_NINE));
		cultivesPerSpecie.setNewText(HandlerLanguage.languageProperties
				.getProperty(ConstantsGUI.T_TEXT_REPORT_GRAPHICS_TEN));
	}
