...
public class JPXAxisBarGraphic extends JPanel {
    ...
    public JPXAxisBarGraphic(int colsQuantity, int xInit){
        ...
        this.setPreferredSize(new Dimension(this.axisWidth,ConstantsGUI.AXIS_LINE_WIDTH));
    }
    ...
    public void paint(final Graphics g) {
        ...
        g.fillRect(this.xAxisInit,0, this.axisWidth, ConstantsGUI.AXIS_LINE_WIDTH);
