...
public class JPCircleGraphicPanel extends JPanel {
	...
	public JPCircleGraphicPanel(ActionListener actionListener) {
		...
		// (ConstantsGUI.CIRCLE_GRAPHIC_RADIOUS * 2 +300/*
		// panelInformation.getSize().getWidth()
		// */),ConstantsGUI.CIRCLE_GRAPHIC_RADIOUS * 2));
	}
	...
	private void initComponents(HashMap<String, Double> valueList) {
		HashMap<String, Color> informationPanelData = this
				.getInformationPanelData(valueList);
	...
	private void addGroupComponents() {
		this.layout.setVerticalGroup(this.layout.createParallelGroup()
				.addComponent(this.circleGraphicPanel)
	...
	private void addCircleGraphicPanel(HashMap<String, Double> valueList,
			HashMap<String, Color> informationPanelData) {
		this.setCircleGraphicPanelFormat();
		this.circleGraphicPanel.add(new JLArcLabel(valueList,
	...
	public void setCircleGraphicPanelFormat() {
		...
		this.circleGraphicPanel.setMinimumSize(new Dimension(
				ConstantsGUI.CIRCLE_GRAPHIC_RADIOUS * 2,
				ConstantsGUI.CIRCLE_GRAPHIC_RADIOUS * 2));
		this.circleGraphicPanel.setBorder(BorderFactory.createEmptyBorder(20,
				0, 0, 0));
	...
	public void paint(Graphics g) {
		...
		g.drawLine((int) (this.getWidth() * 0.999), 0,
				(int) (this.getWidth() * 0.999),
				(int) (this.getHeight() * 0.999));
		g.drawLine(0, (int) (this.getHeight() * 0.999),
				(int) (this.getWidth() * 0.999),
				(int) (this.getHeight() * 0.999));
	}
}